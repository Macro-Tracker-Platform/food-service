...
public class GeminiService {
    ...
    private Map<String, Object> foodVoiceResponseSchema() {
        Map<String, Object> nutrition = Map.of(
                "type", "OBJECT",
                "required", List.of("calories", "protein_g", "fat_g", "carbs_g"),
                "properties", Map.of(
        ...
        Map<String, Object> item = Map.of(
                ...
                "properties", Map.of(
                        "name", Map.of(
                                "type", "STRING",
                                "description", "Specific food item name with preparation"
                                               + " method in the requested language."
                        ),
                        "search_name", Map.of(
                                "type", "STRING",
                        ...
                        "estimated_weight_grams", Map.of(
                                "type", "NUMBER",
                                "minimum", 0,
                                "description", "Total edible weight in grams. Must be a"
                                               + " realistic default if user did not specify."
                        ),
                        "confidence_score", Map.of(
                                "type", "NUMBER",
                                "minimum", 0,
